...
const FINDINGS: Entry[] = [
  ...
  { id: 'key-001', name: 'service_role key shipped in the client bundle', category: 'sensitive-data-exposure', cwe: 'CWE-522', owasp_2025: 'A04', discovery_mechanism: 'bundle-mining', reachable_by_other_means: false, location: 'NEXT_PUBLIC_SUPABASE_SERVICE_KEY in the compiled JS', severity: 'critical', is_control: false, paired_control: 'ctl-001', occurred: 'planted' },
  { id: 'key-002', name: 'OpenAI-shaped API key in the client bundle', category: 'sensitive-data-exposure', cwe: 'CWE-522', owasp_2025: 'A04', discovery_mechanism: 'bundle-mining', reachable_by_other_means: false, location: 'NEXT_PUBLIC_FAKE_OPENAI_KEY in the compiled JS', severity: 'high', is_control: false, paired_control: 'ctl-011', occurred: 'planted' },
  ...
  { id: 'llm-001', name: 'Full system prompt embedded as a bundle string literal', category: 'information-disclosure', cwe: 'CWE-200', owasp_2025: 'A02', discovery_mechanism: 'bundle-mining', reachable_by_other_means: false, location: 'SYSTEM_PROMPT in the compiled JS', severity: 'low', is_control: false, paired_control: null, occurred: 'planted' },
  { id: 'llm-002', name: 'Synthetic personal data interpolated into the client-side prompt', category: 'sensitive-data-exposure', cwe: 'CWE-359', owasp_2025: 'A04', discovery_mechanism: 'bundle-mining', reachable_by_other_means: false, location: 'DEMO_ACCOUNT in the compiled JS', severity: 'medium', is_control: false, paired_control: null, occurred: 'planted', note: 'all values synthetic and labelled as such' },
  { id: 'inj-001', name: 'PostgREST filter injection in project search', category: 'injection', cwe: 'CWE-943', owasp_2025: 'A05', discovery_mechanism: 'suffix-convention', reachable_by_other_means: false, location: 'GET {basePath}/api/projects/search?q=', severity: 'high', is_control: false, paired_control: 'ctl-012', occurred: 'planted' },
  { id: 'tmpl-001', name: 'Server-side template injection via a body-only field', category: 'injection', cwe: 'CWE-1336', owasp_2025: 'A05', discovery_mechanism: 'schema-error', reachable_by_other_means: false, location: 'POST {basePath}/api/feedback, field renderTemplate', severity: 'high', is_control: false, paired_control: null, occurred: 'planted', note: 'Templates are evaluated: {{7*7}} -> 49. SCOPE: arithmetic and named context vars only — no eval, no property access, no host objects. {{constructor.constructor}} does not resolve. Reporting SSTI is correct; reporting RCE overclaims.' },
  { id: 'probe-001', name: 'Deployment .env served under the app root', category: 'sensitive-data-exposure', cwe: 'CWE-538', owasp_2025: 'A02', discovery_mechanism: 'path-probe', reachable_by_other_means: false, location: 'GET {basePath}/.env', severity: 'critical', is_control: false, paired_control: null, occurred: 'planted', note: 'resolves against the APP root, not the origin; JWT_SECRET and service_role key inside' },
  { id: 'probe-002', name: 'Git config with embedded token served under the app root', category: 'sensitive-data-exposure', cwe: 'CWE-538', owasp_2025: 'A02', discovery_mechanism: 'path-probe', reachable_by_other_means: false, location: 'GET {basePath}/.git/config', severity: 'high', is_control: false, paired_control: null, occurred: 'planted', note: 'resolves against the APP root, not the origin' },
  ...
  { id: 'info-001', name: 'PostgREST OpenAPI root discloses the full schema', category: 'information-disclosure', cwe: 'CWE-200', owasp_2025: 'A02', discovery_mechanism: 'baas-direct', reachable_by_other_means: false, location: 'GET /rest/v1/ on the Supabase gateway', severity: 'medium', is_control: false, paired_control: null, occurred: 'naturally', variant_group: 'backend-disclosure' },
  { id: 'info-002', name: 'Verbose SQL errors leak column names and SQLSTATE', category: 'information-disclosure', cwe: 'CWE-209', owasp_2025: 'A10', discovery_mechanism: 'baas-direct', reachable_by_other_means: false, location: 'PostgREST error responses', severity: 'low', is_control: false, paired_control: null, occurred: 'naturally', variant_group: 'backend-disclosure', note: 'Same variant_group as info-001: both are backend disclosure through the data API. A consumer that counts these as ONE finding is not missing anything.' },
  { id: 'cookie-001', name: 'Session cookie is not HttpOnly, not Secure, and lives 400 days', category: 'session-management', cwe: 'CWE-1004', owasp_2025: 'A02', discovery_mechanism: 'authed-discovery', reachable_by_other_means: false, location: 'Set-Cookie sb-localhost-auth-token', severity: 'medium', is_control: false, paired_control: null, occurred: 'naturally' },
  ...
  { id: 'err-001', name: 'Supabase errors discarded across 13 call sites', category: 'error-handling', cwe: 'CWE-390', owasp_2025: 'A10', discovery_mechanism: 'source-review', reachable_by_other_means: false, location: 'web/src — 9 read paths, 4 write paths', severity: 'low', is_control: false, paired_control: null, occurred: 'naturally' },
  { id: 'hdr-001', name: 'No security response headers on any app route', category: 'security-misconfiguration', cwe: 'CWE-693', owasp_2025: 'A02', discovery_mechanism: 'static-crawl', reachable_by_other_means: false, location: 'all {basePath}/* responses', severity: 'medium', is_control: false, paired_control: null, occurred: 'naturally' },
  { id: 'hdr-002', name: 'X-Powered-By discloses the framework', category: 'security-misconfiguration', cwe: 'CWE-200', owasp_2025: 'A02', discovery_mechanism: 'static-crawl', reachable_by_other_means: false, location: 'all {basePath}/* responses', severity: 'info', is_control: false, paired_control: null, occurred: 'naturally' },
  { id: 'hdr-003', name: 'PostgREST version banner on the data API', category: 'security-misconfiguration', cwe: 'CWE-200', owasp_2025: 'A02', discovery_mechanism: 'baas-direct', reachable_by_other_means: false, location: 'all /rest/v1/* responses', severity: 'info', is_control: false, paired_control: null, occurred: 'naturally' },
]
